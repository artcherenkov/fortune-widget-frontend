  ...
  const PRIZES = [
    {
      ...
      fullText:
        "Поздравляем! Вы выиграли сертификат на 2000 рублей на лазерную эпиляцию зоны «Все тело» на любом диодном лазере.",
    ...
    },
    {
      ...
      fullText:
        "Поздравляем! Вы выиграли сертификат на 5000 рублей на лазерную эпиляцию зоны «Все тело» на любом александритовом лазере.",
      url: "https://google.com",
    ...
    },
    {
      ...
      fullText:
        "Поздравляем! Вы выиграли сертификат на 1500 рублей на лазерную эпиляцию зон «Бикини+подмышки» на любом диодном лазере.",
      url: "https://google.com",
      color: "rgb(30,157,178)",
      textColor: "#E6FFFF",
    },
    {
      ...
      fullText:
        "Поздравляем! Вы выиграли сертификат на 3000 рублей на лазерную эпиляцию зон «Бикини+подмышки» на любом александритовом лазере.",
      url: "https://google.com",
      color: "rgb(42,183,193)",
      textColor: "#E6FFFF",
    },
    {
      ...
      extraText: "*Стоимость процедуры с сертификатом 1990 рублей",
      fullText:
        "Поздравляем! Вы выиграли сертификат на 2000 рублей на лазерную эпиляцию зон «Бикини+подмышки+ голени с коленями» на любом диодном лазере.",
      url: "https://google.com",
      color: "#E6FFFF",
      textColor: "#1E96B4",
    },
    {
      ...
      fullText:
        "Поздравляем! Вы выиграли сертификат на 5000 рублей на лазерную эпиляцию зон «Бикини+подмышки+ голени с коленями» на любом александритовом лазере.",
      url: "https://google.com",
      color: "#E6FFFF",
      textColor: "#1E96B4",
    },
