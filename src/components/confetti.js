...
(function () {
  ...
  function startConfettiInner(rootSelector) {
    ...
    if (canvas === null) {
      ...
      canvas.setAttribute(
        "style",
        `display:block;z-index:999999;pointer-events:none;position:fixed;top:${top}px;left:${left}px;bottom:${bottom}px;right:${right}px`
      );
